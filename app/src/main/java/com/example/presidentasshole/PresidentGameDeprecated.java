 ...
 *
 */
public class PresidentGameDeprecated implements View.OnClickListener {

    private ArrayList<Player> players;
    private PresidentGameStateDeprecated game_state;
    ...
    public PresidentGameDeprecated(RelativeLayout card_view, RelativeLayout play_view) {
    ...
    public PresidentGameStateDeprecated getGameState() {
        return game_state;
    }

    public void setGameState(PresidentGameStateDeprecated game_state) {
